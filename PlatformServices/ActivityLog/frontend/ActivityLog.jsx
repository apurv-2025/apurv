...
import { Calendar, Clock, MapPin, User, Shield, History } from 'lucide-react';
...
const EventTable: React.FC<{ events: ActivityEvent[]; hideDetails?: boolean }> = ({ 
  events, 
  hideDetails = false 
}) => {
  return (
...
const SignInEventsTab: React.FC<{ events: ActivityEvent[] }> = ({ events }) => {
  return (
    <div>
      <div className="mb-4">
...
const HIPAAAuditLogTab: React.FC<{ events: ActivityEvent[] }> = ({ events }) => {
  return (
    <div>
      <div className="mb-4">
...
const HistoryTab: React.FC<{ events: ActivityEvent[] }> = ({ events }) => {
  return (
    <div>
      <div className="mb-4">
...
const ActivityLog: React.FC = () => {
  ...
  const renderTabContent = () => {
    ...
    switch (activeTab) {
      case 'sign_in':
        return <SignInEventsTab events={events} />;
      case 'hipaa':
        return <HIPAAAuditLogTab events={events} />;
      case 'history':
      default:
